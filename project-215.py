...
def generate_lidar_blueprint(blueprint_library):
    ...
    lidar_blueprint.set_attribute('range', str(100.00*200))
...
try:
    ...
    sensor_lidar_spawn_point = carla.Transform(x=0, y=0, z=2.0, pitch=0.000000, yaw=90.0, roll=0.000000)
    ...
    visualise_lidar_using_mayavi = mlab.points3d(10, 10, 10, 10, mode='point', color_map = 'gnuplot', figure=lidar_figure)
